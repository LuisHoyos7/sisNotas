...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/home') }}"><b>Tracing Unicor</b> Inicio de Sesion</a>
    </div>
    ...
    <div class="login-box-body">
        ...
        <a href="{{ route('google') }}" class="text-center btn btn-block btn-social btn-google"><i class="fa fa-google-plus"></i><center>Ingresar Con Google</center><a>
