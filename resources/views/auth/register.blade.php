...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>Tracing</b> Registro</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <a href="{{ url('/login') }}" class="text-center btn btn-primary btn-block btn-flat">Inicio de Sesion</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
